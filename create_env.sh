...
pip install black isort pylint mypy nltk scikit-learn sentence-transformers transformers tokenizers tqdm click wandb nvidia-cublas-cu12 datasets huggingface_hub
